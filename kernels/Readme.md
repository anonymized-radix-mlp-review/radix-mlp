...
```toml
[dependencies]
candle-index-select-cu = { git = "https://github.com/anonymized/candle-index-select-cu" }
...
```toml
[dependencies]
candle-index-select-cu = { git = "https://github.com/anonymized/candle-index-select-cu", default-features = false, features = ["cuda-11"] }
```
